...
public class metodosEncriptacao {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nTEXTO A SER CRIPTOGRAFADO: DANIEL CANTOR SERTANEJO\n");
		System.out.println("\n###########################################################################\n");
		
		String textoCriptografado = encriptarCifraCesar(10, "DANIEL CANTOR SERTANEJO");
        String textoDescriptografado = decriptarCifraCesar(10, textoCriptografado);

        System.out.println("\nTEXTO CRIPTOGRAFADO CIFRA CESAR: " + textoCriptografado);
        System.out.println("TEXTO DESCRIPTOGRAFADO CIFRA CESAR: " + textoDescriptografado);
        
        System.out.println("\n###########################################################################\n");
        
        String textoCriptografadoVigenere = codificarCifraVigenere("TRABALHO DO CAPETA", "DANIEL CANTOR SERTANEJO");
        String textoDescriptografadoVigenere = decodificarCifraVigenere("TRABALHO DO CAPETA", textoCriptografadoVigenere);

        System.out.println("\nTEXTO CRIPTOGRAFADO CIFRA VIGENERE: " + textoCriptografadoVigenere);
        System.out.println("TEXTO DESCRIPTOGRAFADO CIFRA VIGENERE: " + textoDescriptografadoVigenere);
        
        System.out.println("\n###########################################################################\n");
        
        String textoCriptografadoAES = codificarAES("DANIEL CANTOR SERTANEJO", "TRABALHO DO CAPETA");
        String textoDescriptografadoAES = decodificarAES(textoCriptografadoAES, "TRABALHO DO CAPETA");

        System.out.println("\nTEXTO CRIPTOGRAFADO AES: " + textoCriptografadoAES);
        System.out.println("TEXTO DESCRIPTOGRAFADO AES: " + textoDescriptografadoAES);
